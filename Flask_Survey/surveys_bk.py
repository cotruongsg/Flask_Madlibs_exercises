...
class Survey:
    ...
    def __str__(self):
        survey_str = self.title + '\n' + self.instructions + '\n\n'
        for question in self.questions:
            survey_str += question.question + '\n'
        return survey_str

# Use print below in IPython
# print("Title:", satisfaction_survey.title)
# print("Instructions:", satisfaction_survey.instructions)
# print("Questions:")
# for i, question in enumerate(satisfaction_survey.questions):
#     print(f"  {i + 1}. {question.question}")
#     print(f"     Choices: {question.choices}")
#     print(f"     Allow text: {question.allow_text}")
